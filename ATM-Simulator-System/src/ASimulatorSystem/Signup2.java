...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        String religion[] = {"Buddha","Hindu","Muslim","Sikh","Christian","Other"};
        c1 = new JComboBox(religion);
        c1.setBackground(Color.WHITE);
        c1.setFont(new Font("Raleway", Font.BOLD, 14));
        
        String category[] = {"Chinese","Malay","India","Other"};
        c2 = new JComboBox(category);
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway", Font.BOLD, 14));
        
        String income[] = {"Null","<1,500","<2,500","<5,000","Upto 10,000","Above 100,000"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t1.getText().equals("")){
                ...
                Conn c1 = new Conn();
               String q1 = "insert into signuptwo values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+ic+"','"+scitizen+"','"+eaccount+"')";
